...
void draw_straight_through_wiring()
{
    ...
    // Pin 1   white-orange <-> white-orange
    tft.fillRect(X_OFFSET_FIRST                             , Y_BASE_OFFSET, BOX_WIDTH, BOX_HEIGHT, ST77XX_WHITE);
    tft.fillRect(X_OFFSET_FIRST + BOX_WIDTH                 , Y_BASE_OFFSET, BOX_WIDTH, BOX_HEIGHT, ST77XX_ORANGE);
    tft.fillRect(X_OFFSET_FIRST + 2 * BOX_WIDTH, Y_BASE_OFFSET + 0 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 2   orange       <-> orange
    tft.fillRect(X_OFFSET_FIRST                             , Y_BASE_OFFSET + BOX_HEIGHT + Y_OFFSET_BTWN_BOXES, BOX_WIDTH * 2, BOX_HEIGHT, ST77XX_ORANGE);
    tft.fillRect(X_OFFSET_FIRST + 2 * BOX_WIDTH, Y_BASE_OFFSET + (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 3   white-green <-> white-green
    tft.fillRect(X_OFFSET_FIRST                             , Y_BASE_OFFSET + 2 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_WHITE);
    tft.fillRect(X_OFFSET_FIRST + BOX_WIDTH                 , Y_BASE_OFFSET + 2 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_GREEN);
    tft.fillRect(X_OFFSET_FIRST + 2 * BOX_WIDTH, Y_BASE_OFFSET + 2 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 4   blue         <-> blue
    tft.fillRect(X_OFFSET_FIRST                             , Y_BASE_OFFSET + 3 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH * 2, BOX_HEIGHT, ST77XX_BLUE);
    tft.fillRect(X_OFFSET_FIRST + 2 * BOX_WIDTH, Y_BASE_OFFSET + 3 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 5   white-blue   <-> white-blue
    tft.fillRect(X_OFFSET_FIRST                             , Y_BASE_OFFSET + 4 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_WHITE);
    tft.fillRect(X_OFFSET_FIRST + BOX_WIDTH                 , Y_BASE_OFFSET + 4 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_BLUE);
    tft.fillRect(X_OFFSET_FIRST + 2 * BOX_WIDTH, Y_BASE_OFFSET + 4 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 6   green        <-> green
    tft.fillRect(X_OFFSET_FIRST                             , Y_BASE_OFFSET + 5 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH * 2, BOX_HEIGHT, ST77XX_GREEN);
    tft.fillRect(X_OFFSET_FIRST + 2 * BOX_WIDTH, Y_BASE_OFFSET + 5 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 7   white-brown  <-> white-brown
    tft.fillRect(X_OFFSET_FIRST                             , Y_BASE_OFFSET + 6 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_WHITE);
    tft.fillRect(X_OFFSET_FIRST + BOX_WIDTH                 , Y_BASE_OFFSET + 6 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, BROWN_COLOR);
    tft.fillRect(X_OFFSET_FIRST + 2 * BOX_WIDTH, Y_BASE_OFFSET + 6 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 8   brown        <-> brown
    tft.fillRect(X_OFFSET_FIRST                             , Y_BASE_OFFSET + 7 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH * 2, BOX_HEIGHT, BROWN_COLOR);
    tft.fillRect(X_OFFSET_FIRST + 2 * BOX_WIDTH, Y_BASE_OFFSET + 7 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 1   white-green  <-> white-green
    tft.fillRect(X_OFFSET_SECOND                             , Y_BASE_OFFSET, BOX_WIDTH, BOX_HEIGHT, ST77XX_WHITE);
    tft.fillRect(X_OFFSET_SECOND + BOX_WIDTH                 , Y_BASE_OFFSET, BOX_WIDTH, BOX_HEIGHT, ST77XX_GREEN);
    tft.fillRect(X_OFFSET_SECOND + 2 * BOX_WIDTH, Y_BASE_OFFSET + 0 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 2   green        <-> green
    tft.fillRect(X_OFFSET_SECOND                             , Y_BASE_OFFSET + BOX_HEIGHT + Y_OFFSET_BTWN_BOXES, BOX_WIDTH * 2, BOX_HEIGHT, ST77XX_GREEN);
    tft.fillRect(X_OFFSET_SECOND + 2 * BOX_WIDTH, Y_BASE_OFFSET + 1 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 3   white-orange <-> white-orange
    tft.fillRect(X_OFFSET_SECOND                             , Y_BASE_OFFSET + 2 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_WHITE);
    tft.fillRect(X_OFFSET_SECOND + BOX_WIDTH                 , Y_BASE_OFFSET + 2 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_ORANGE);
    tft.fillRect(X_OFFSET_SECOND + 2 * BOX_WIDTH, Y_BASE_OFFSET + 2 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 4   blue         <-> blue
    tft.fillRect(X_OFFSET_SECOND                             , Y_BASE_OFFSET + 3 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH * 2, BOX_HEIGHT, ST77XX_BLUE);
    tft.fillRect(X_OFFSET_SECOND + 2 * BOX_WIDTH, Y_BASE_OFFSET + 3 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 5   white-blue   <-> white-blue
    tft.fillRect(X_OFFSET_SECOND                             , Y_BASE_OFFSET + 4 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_WHITE);
    tft.fillRect(X_OFFSET_SECOND + BOX_WIDTH                 , Y_BASE_OFFSET + 4 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_BLUE);
    tft.fillRect(X_OFFSET_SECOND + 2 * BOX_WIDTH, Y_BASE_OFFSET + 4 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 6   orange       <-> orange
    tft.fillRect(X_OFFSET_SECOND                             , Y_BASE_OFFSET + 5 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH * 2, BOX_HEIGHT, ST77XX_ORANGE);
    tft.fillRect(X_OFFSET_SECOND + 2 * BOX_WIDTH, Y_BASE_OFFSET + 5 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 7   white-brown  <-> white-brown
    tft.fillRect(X_OFFSET_SECOND                             , Y_BASE_OFFSET + 6 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, ST77XX_WHITE);
    tft.fillRect(X_OFFSET_SECOND + BOX_WIDTH                 , Y_BASE_OFFSET + 6 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH, BOX_HEIGHT, BROWN_COLOR);
    tft.fillRect(X_OFFSET_SECOND + 2 * BOX_WIDTH, Y_BASE_OFFSET + 6 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
    ...
    // Pin 8   brown        <-> brown
    tft.fillRect(X_OFFSET_SECOND                             , Y_BASE_OFFSET + 7 * (BOX_HEIGHT + Y_OFFSET_BTWN_BOXES), BOX_WIDTH * 2, BOX_HEIGHT, BROWN_COLOR);
    tft.fillRect(X_OFFSET_SECOND + 2 * BOX_WIDTH, Y_BASE_OFFSET + 7 * (Y_OFFSET_BTWN_BOXES + BOX_HEIGHT) + (BOX_HEIGHT - WIRE_HEIGHT) / 2, WIRE_WIDTH, WIRE_HEIGHT, ST77XX_YELLOW);
